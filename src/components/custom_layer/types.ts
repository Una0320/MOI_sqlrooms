 ...
 */
export type _ArrowInternalLayerData<T> = ArrowLayerData<T> & {
  /**
...
export type _InternalAccessorContext<T> = AccessorContext<T> & {
  /** The value of the `data` prop */
  data: _ArrowInternalLayerData<T>;
};
...
export type ArrowPickingInfo = PickingInfo & {
